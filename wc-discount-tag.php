...
require_once( 'classes/discounts/exceptions.php' );
require_once( 'classes/discounts/abstractdiscount.php' );
require_once( 'classes/discounts/flatdiscount.php' );
require_once( 'classes/discounts/percentdiscount.php' );
require_once( 'classes/discounts/productdiscount.php' );
